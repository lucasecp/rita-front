...
import { WalletPatientBuyCoinInputCustom } from './input-custom'
import { WalletPatientBuyCoinSelectPayment } from './select-payment'

export const WalletPatientBuyCoinInputSimple: React.FC = () => {
  ...
  function handleCustomValueClick() {
    showMessage(WalletPatientBuyCoinInputCustom, { walletBalance }, true)
  }
