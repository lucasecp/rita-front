import type { FinancialListItemModel } from '@/pages/Wallet/OperatorSettings/components/FinancialListItem'
...
import FinancialList from '@/pages/Wallet/OperatorSettings/components/FinancialList'
import FinancialListItem from '@/pages/Wallet/OperatorSettings/components/FinancialListItem'
import PixKeySelectForm from '@/pages/Wallet/OperatorSettings/components/PixKeySelectForm'
import BankAccountForm from '@/pages/Wallet/OperatorSettings/components/BankAccountForm'

export const WalletOperatorSettings: React.FC = () => {
