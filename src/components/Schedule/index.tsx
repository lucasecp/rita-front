...
//     // view - string
//     let img =
//       '<img style="top: 2px; position: relative;" src="./../images/person.png"/>'
//     if (data.appointment.subject === 'Nancy') {
//       img =
//         '<img style="top: 2px; position: relative;" src="./../images/woman.png"/>'
//     } else if (data.appointment.subject === 'Peter') {
//       img =
//         '<img style="top: 2px; position: relative;" src="./../images/boss.png"/>'
//     } else if (data.appointment.subject === 'Antony') {
//       img =
//         '<img style="top: 2px; position: relative;" src="./../images/oldboss.png"/>'
//     } else if (data.appointment.subject === 'John') {
//       img =
//         '<img style="top: 2px; position: relative;" src="./../images/asian.png"/>'
//     }
//     if (
//       data.view === 'weekView' ||
//       data.view === 'dayView' ||
...
//         data.style = '#AA4643'
//       } else if (
//         data.appointment.id === 'id2' ||
//         data.appointment.id === 'id6'
//       ) {
//         data.style = '#309B46'
